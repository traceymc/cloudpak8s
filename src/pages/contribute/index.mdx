---
title: Contributing to the Cloud Pak Playbook
description: Guide for contributing content to the Cloud Pak Playbook
keywords: 'ibm,cloud pak,playbook'
---
...
suggestions, improve documentation, and contribute code.
</PageDescription> 
...
the repository's 
[**Issues**](https://github.com/ibm-cloud-architecture/cloudpak8s/issues) 
list.  
...
submission.
   - There is a way to run a development instance of the Cloud Pak 
...
the GUI at
[https://github.com/ibm-cloud-architecture/cloudpak8s](https://github.com/ibm-cloud-architecture/cloudpak8s)
