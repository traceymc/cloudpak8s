...
<AnchorLinks>
  <AnchorLink>Make sure permissions are set</AnchorLink>
  <AnchorLink>Create MQ instance in Cloud Pak for Integration</AnchorLink>
  <AnchorLink>Monitoring the Deployment</AnchorLink>
  <AnchorLink>Register with Tracing Service</AnchorLink>
</AnchorLinks>
